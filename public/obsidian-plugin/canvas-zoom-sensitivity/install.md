手動インストールできます。ビルド済みなので、再ビルドは不要です。
  ...
  - public/obsidian-plugin/canvas-zoom-sensitivity/manifest.json
  - public/obsidian-plugin/canvas-zoom-sensitivity/main.js
  - public/obsidian-plugin/canvas-zoom-sensitivity/versions.json
